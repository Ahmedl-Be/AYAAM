...
export default class CartItems extends Component {
    ...
    updateCartItemControls(id, color, size) {
        ...
        const cartCard = document.querySelector(`.cart-card[data-id="${id}"][data-color="${color}"][data-size="${size}"]`);
        if (!cartCard) return;

        const controlsContainer = cartCard.querySelector('.cart-item');
    ...
    attachItemEventListeners(cartCard) {
        const increaseBtn = cartCard.querySelector('.icrease-btn');
        const decreaseBtn = cartCard.querySelector('.decrease-btn');
        const deleteBtn = cartCard.querySelector('.delete-btn');
