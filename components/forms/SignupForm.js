export default function SignupForm() {
    ...
    <form id="signupForm" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="nameError" class="invalid-feedback">Please enter your full name.</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="repeatedPassword" required>
                            <div id="repeatPasswordError" class="invalid-feedback">Passwords must match.</div>
                        ...
                        <div class="mb-4 form-check">
                            ...
                            <div id="termsError" class="invalid-feedback d-block">You must accept the terms.</div>
                        </div>
